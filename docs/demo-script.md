...
## 0:00–0:45 — Public evidence first
...
## 0:45–1:30 — Show the honesty boundary
...
## 2:20–3:25 — Build an explicitly synthetic delivered-cost scenario
...
Close on the current limitation: the product is demonstrable now as a public-data and analyst-scenario intelligence workspace; it is not yet a complete live physical-oil platform.
