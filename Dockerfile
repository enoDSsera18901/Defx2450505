...
COPY --from=build --chown=node:node /app/data/steo-official-vintages ./data/steo-official-vintages
COPY --from=build --chown=node:node /app/data/public-market-snapshots ./data/public-market-snapshots
USER node
EXPOSE 3000
