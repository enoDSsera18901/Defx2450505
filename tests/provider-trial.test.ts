...
test('reports a structurally complete bounded trial sample without claiming provider quality', () => {
  ...
  assert.equal(report.cargoCoverage.distinctGrades, 2);
  assert.equal(report.cargoCoverage.distinctRoutes, 2);
